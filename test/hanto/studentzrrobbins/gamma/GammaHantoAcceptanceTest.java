// $codepro.audit.disable missingAssertInTestMethod, methodJavadoc
/*******************************************************************************
...
public class GammaHantoAcceptanceTest
{
	...
	public void tryToMoveTooFar() throws HantoException
	{
		...
		//TODO: REMOVE
		System.out.println("TEST tryToMoveTooFar: " + game.getPrintableBoard());
	}
	...
	{
		System.out.println("Test: blueWins");
	...
	{
		System.out.println("Test: redSelfLoses");
		MoveResult mr = makeMoves(md(BUTTERFLY, 0, 0), md(BUTTERFLY, 0, 1),
				md(SPARROW, -1, 0), md(SPARROW, 0, 2),
