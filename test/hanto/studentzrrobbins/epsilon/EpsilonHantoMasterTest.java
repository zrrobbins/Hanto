...
public class EpsilonHantoMasterTest
{
	...
	@Test
	public void redPlacesInitialHorseAtOrigin() throws HantoException
	{
		assertEquals(OK, redGame.makeMove(HORSE, null, new TestHantoCoordinate(0, 0)));
		final HantoPiece p = redGame.getPieceAt(makeCoordinate(0, 0));
		assertEquals(RED, p.getColor());
	...
	public void tryAndFly5SpacesRedPlayer() throws HantoException {
		blueGame.makeMove(CRAB, null, new TestHantoCoordinate(0,0));
		blueGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(1,0));
		blueGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0,-1));
		blueGame.makeMove(SPARROW, null, new TestHantoCoordinate(2,0));
		...
		assertEquals(OK, blueGame.makeMove(SPARROW, new TestHantoCoordinate(0,-2), new TestHantoCoordinate(3,0)));
	...
	@Test(expected=HantoException.class)
	public void blueTriesToResignButThereAreStillMoves() throws HantoException
	{
		redGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0,0));
		redGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0,-1));
		redGame.makeMove(SPARROW, null, new TestHantoCoordinate(0,1));
		redGame.makeMove(CRAB, null, new TestHantoCoordinate(1,-2));
		assertEquals(OK, redGame.makeMove(SPARROW, new TestHantoCoordinate(0,1), new TestHantoCoordinate(1,-1)));
		assertNotEquals(RED_WINS, redGame.makeMove(null, null, null));
	}	
	
	@Test(expected=HantoException.class)
	public void blueHorseTriesToMoveToAdjacentSpot() throws HantoException
	{
		redGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0,0));
		redGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0,-1));
		redGame.makeMove(HORSE, null, new TestHantoCoordinate(0,1));
		redGame.makeMove(BUTTERFLY, new TestHantoCoordinate(0,-1), new TestHantoCoordinate(1,-1));
		assertEquals(OK, redGame.makeMove(HORSE, new TestHantoCoordinate(0,1), new TestHantoCoordinate(1,0)));
	}
	
	@Test(expected=HantoException.class)
	public void blueHorseTriesToJumpToSameLocation() throws HantoException
	{
		redGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0,0));
		redGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0,-1));
		redGame.makeMove(HORSE, null, new TestHantoCoordinate(0,1));
		redGame.makeMove(BUTTERFLY, new TestHantoCoordinate(0,-1), new TestHantoCoordinate(1,-1));
		assertEquals(OK, redGame.makeMove(HORSE, new TestHantoCoordinate(0,1), new TestHantoCoordinate(0,1)));
	}
	
	@Test(expected=HantoException.class)
	public void redHorseTriesToJumpOverEmptySpace() throws HantoException
	{
		redGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0,0));
		redGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0,-1));
		redGame.makeMove(HORSE, null, new TestHantoCoordinate(0,1));
		redGame.makeMove(BUTTERFLY, new TestHantoCoordinate(0,-1), new TestHantoCoordinate(1,-1));
		assertEquals(OK, redGame.makeMove(HORSE, new TestHantoCoordinate(0,1), new TestHantoCoordinate(2,-1)));
	}
	
	@Test	
	public void redHorseJumpsOver1Piece() throws HantoException
	{
		redGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0,0));
		redGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0,-1));
		redGame.makeMove(HORSE, null, new TestHantoCoordinate(0,1));
	...
	@Test(expected=HantoException.class)
	public void blueHorseTriesToJumpOverThreeSpacesWithAnEmptySpot() throws HantoException
	{
		blueGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0,0));
		blueGame.makeMove(HORSE, null, new TestHantoCoordinate(-1,1));
		blueGame.makeMove(CRAB, null, new TestHantoCoordinate(0,-1));
		blueGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(-1,2));
		blueGame.makeMove(CRAB, null, new TestHantoCoordinate(1,-2));
		blueGame.makeMove(BUTTERFLY, new TestHantoCoordinate(-1,2), new TestHantoCoordinate(0,1));
		blueGame.makeMove(SPARROW, null, new TestHantoCoordinate(2,-2));
		assertEquals(OK, blueGame.makeMove(HORSE, new TestHantoCoordinate(-1,1), new TestHantoCoordinate(3,-3)));
	}
	
	@Test
	public void redHorseJumpsOver4Pieces() throws HantoException
	{
		blueGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0,0));
		blueGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(-1,0));
		blueGame.makeMove(CRAB, null, new TestHantoCoordinate(1,0));
		blueGame.makeMove(HORSE, null, new TestHantoCoordinate(-2,0));
		blueGame.makeMove(SPARROW, null, new TestHantoCoordinate(2,0));
		assertEquals(OK, blueGame.makeMove(HORSE, new TestHantoCoordinate(-2,0), new TestHantoCoordinate(3,0)));
		final HantoPiece redHorse = blueGame.getPieceAt(new TestHantoCoordinate(3, 0));
		assertEquals(HORSE, redHorse.getType());
		assertEquals(RED, redHorse.getColor());
	}
	
	@Test(expected=HantoException.class)
	public void noStraightLineToGoalBlueHorseJump() throws HantoException
	{
		redGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0,0));
		redGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(-1,0));
		redGame.makeMove(CRAB, null, new TestHantoCoordinate(1,0));
		redGame.makeMove(HORSE, null, new TestHantoCoordinate(-2,0));
		redGame.makeMove(SPARROW, null, new TestHantoCoordinate(2,0));
		assertEquals(OK, redGame.makeMove(HORSE, new TestHantoCoordinate(-2,0), new TestHantoCoordinate(3,-1)));
	}
	
	
	// next one try along the bottom left to upper right diagonal
	...
	public void redPlayerResignsPrematurely() throws HantoException 
	{
		blueGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0,0));
		blueGame.makeMove(BUTTERFLY, null, new TestHantoCoordinate(1,0));
		blueGame.makeMove(BUTTERFLY, new TestHantoCoordinate(0,0), new TestHantoCoordinate(0,1));
	...
	public void blueCrabWalksToWin() throws HantoException
	{
		...
		redGame.makeMove(CRAB, new TestHantoCoordinate(2,0), new TestHantoCoordinate(2,-1));
		redGame.makeMove(CRAB, new TestHantoCoordinate(-2,1), new TestHantoCoordinate(-2,2));
		assertEquals(BLUE_WINS, redGame.makeMove(CRAB, new TestHantoCoordinate(2,-1), new TestHantoCoordinate(1,-1)));
	}
	...
	public void blueRunOutOfCrabs() throws HantoException
	{
		...
		blueGame.makeMove(CRAB, null, new TestHantoCoordinate(0,-5));
		blueGame.makeMove(CRAB, null, new TestHantoCoordinate(0,6));
		blueGame.makeMove(CRAB, null, new TestHantoCoordinate(0,-6));
		blueGame.makeMove(CRAB, null, new TestHantoCoordinate(0,7));
		blueGame.makeMove(CRAB, null, new TestHantoCoordinate(0,-7));
		blueGame.makeMove(CRAB, null, new TestHantoCoordinate(0,8));
		blueGame.makeMove(CRAB, null, new TestHantoCoordinate(0,-8));
		blueGame.makeMove(CRAB, null, new TestHantoCoordinate(0,9));
		blueGame.makeMove(CRAB, null, new TestHantoCoordinate(0,-9));
	}
	...
	public void redWins() throws HantoException
	{
		...
		for(int turns = 1; turns <= 6; turns++)
		{
			...
			case(3): blueGame.makeMove(HORSE, null, makeCoordinate(-1, 1)); break;
			case(4): blueGame.makeMove(CRAB, null, makeCoordinate(0, -1)); break;
			...
			case(2): blueGame.makeMove(HORSE, null, makeCoordinate(1, 1)); break;
			case(3): blueGame.makeMove(SPARROW, null, makeCoordinate(1, 2)); break;
			case(4): blueGame.makeMove(CRAB, null, makeCoordinate(2, -1)); break;
	...
	public void bothPlayersWinAtTheSameTime() throws HantoException
	{
		...
		for(int turns = 1; turns <= 6; turns++)
		{
			...
			case(1): blueGame.makeMove(BUTTERFLY, null, makeCoordinate(0, 0)); break;
			case(2): blueGame.makeMove(SPARROW, null, makeCoordinate(-1, 0)); break;
			case(3): blueGame.makeMove(CRAB, null, makeCoordinate(-1, 1)); break;
			case(4): blueGame.makeMove(CRAB, null, makeCoordinate(0, -1)); break;
			case(5): blueGame.makeMove(SPARROW, null, makeCoordinate(1, -2)); break;
			case(6): blueGame.makeMove(SPARROW, makeCoordinate(1, -2), makeCoordinate(1, -1)); break;
			}
			...
			case(3): blueGame.makeMove(HORSE, null, makeCoordinate(2, 0)); break;
			case(4): blueGame.makeMove(CRAB, null, makeCoordinate(2, -1)); break;
			case(5): blueGame.makeMove(SPARROW, null, makeCoordinate(0, 2)); break;
			case(6): mr = blueGame.makeMove(SPARROW, makeCoordinate(0, 2), makeCoordinate(0, 1)); break;
			}
	...
	@Test
	public void testGenerateAllMoves1() throws HantoException
	{
		blueGame.makeMove(BUTTERFLY, null, makeCoordinate(0, 0));
		assertEquals(24+0, ((EpsilonHantoGame)blueGame).generateAllPossibleMoves().size());
		blueGame.makeMove(SPARROW, null, makeCoordinate(1, 0));
	}
	
	@Test
	public void testGenerateAllMoves2() throws HantoException
	{
		blueGame.makeMove(BUTTERFLY, null, makeCoordinate(0, 0));
		blueGame.makeMove(BUTTERFLY, null, makeCoordinate(1, 0));
		assertEquals(9+2, ((EpsilonHantoGame)blueGame).generateAllPossibleMoves().size());	
	}
	
	@Test
	public void testGenerateAllMoves3() throws HantoException
	{
		blueGame.makeMove(BUTTERFLY, null, makeCoordinate(0, 0));
		blueGame.makeMove(BUTTERFLY, null, makeCoordinate(1, 0));
		blueGame.makeMove(SPARROW, null, makeCoordinate(-1,0));
		blueGame.makeMove(CRAB, null, makeCoordinate(2,-1));
		blueGame.makeMove(CRAB, null, makeCoordinate(-1,1));
		blueGame.makeMove(SPARROW, null, makeCoordinate(2,-2));
		assertEquals(18+15, ((EpsilonHantoGame)blueGame).generateAllPossibleMoves().size());	
	}
	
	@Test
	public void testGenerateAllMoves4() throws HantoException
	{
		blueGame.makeMove(BUTTERFLY, null, makeCoordinate(0, 0));
		blueGame.makeMove(BUTTERFLY, null, makeCoordinate(1, 0));
		blueGame.makeMove(SPARROW, null, makeCoordinate(-1,0));
		blueGame.makeMove(CRAB, null, makeCoordinate(2,-1));
		assertEquals(15+9, ((EpsilonHantoGame)blueGame).generateAllPossibleMoves().size());	
	}
	/*
	 * 
	 * 
	...
	public void blueWins2() throws HantoException
	{
		MoveResult mr = makeMoves(md(BUTTERFLY, 0, 0), md(BUTTERFLY, 0, 1),
				md(SPARROW, -1, 0), md(HORSE, 1, 1),
				md(SPARROW, 1, -1), md(CRAB, 0, 2),
	...
	{
		MoveResult mr = makeMoves(md(BUTTERFLY, 0, 0), md(BUTTERFLY, 0, 1),
				md(SPARROW, -1, 0), md(CRAB, 0, 2),
				md(SPARROW, 1, -1), md(SPARROW, 1, 2),
				md(SPARROW, 1, -1, 1, 0), md(HORSE, -1, 2),
